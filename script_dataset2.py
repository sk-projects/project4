...
benign_dir = os.path.join(dataset2_dir, "benign")
print(benign_dir)
fl_benign_dir_win7 = FileList(benign_dir)
print(fl_benign_dir_win7)
fl_benign_dir_win7.set_Class('Benign')

benign_dir_win10 = os.path.join(dataset2_dir, "benign_win10")
print(benign_dir_win10)
fl_benign_dir_win10 = FileList(benign_dir_win10)
print(fl_benign_dir_win10)
fl_benign_dir_win10.set_Class('Benign')
...
dataset2.save_feature_list(1000, 5, 'dataset2_feature_list.txt')
